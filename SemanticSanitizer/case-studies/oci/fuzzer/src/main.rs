...
use libafl::{
    ...
    stages::{AflStatsStage, mutational::StdMutationalStage},
    state::StdState,
};
use libafl_bolts::{
...
struct Opt {
    ...
    #[arg(
        help = "Tree depth for the Nautilus grammar fuzzer",
        short = 't',
        long = "tree-depth",
        default_value = "100"
    )]
...
pub fn main() {
    ...
    let mut stages = tuple_list!(StdMutationalStage::new(mutator), afl_stats_stage);
